<form id="tambah-barang" enctype="multipart/form-data">
    ...
    $sql = "SELECT * FROM barang_masuk WHERE id_barang_masuk = '$_POST[id]'";
    ...
    <input type="hidden" name="id" value="<?= $rowa['id_barang_masuk'] ?>">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <textarea class="form-control" name="no_surat_jalan" id="no_surat_jalan"
                    placeholder="No Surat Jalan"><?php echo $rowa['no_surat_jalan'] ?></textarea>
            </div>
        </div>
    </div>
...
<script>
    ...
    $("#tambah-barang").submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "pages/penerimaan-barang/proses-penerimaan-barang.php?aksi=update-penerimaan-barang",
            data: formData,
            contentType: false,
            processData: false,
